...
public class BackTestController {
    ...
    @CrossOrigin
    public Map<String, Object> backTest(@PathVariable("code") String code,@PathVariable("ma")int ma
            , @PathVariable("startDate") String strStartDate, @PathVariable("endDate") String strEndDate
    ,@PathVariable("buyThreshold")float buyThreshold,@PathVariable("sellThreshold")float sellThreshold
    ,@PathVariable("serviceCharge") float serviceCharge) throws Exception {
        ...
        Integer winCount = (Integer) simulateResult.get("winCount");
        Integer lossCount = (Integer) simulateResult.get("lossCount");
